...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-12-2023 a las 00:09:00
...
--
-- Estructura de tabla para la tabla `tbl_libtema`
--

CREATE TABLE `tbl_libtema` (
  `lbt_id` int(11) NOT NULL,
  `tem_id` int(11) NOT NULL,
  `lib_id` int(11) NOT NULL,
  `lbt_estado` int(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `tbl_libtema`
--

INSERT INTO `tbl_libtema` (`lbt_id`, `tem_id`, `lib_id`, `lbt_estado`) VALUES
(1, 1, 1, 0),
(2, 1, 2, 0),
(3, 3, 3, 0),
(4, 4, 4, 0);
...
--
-- Indices de la tabla `tbl_libtema`
--
ALTER TABLE `tbl_libtema`
  ADD PRIMARY KEY (`lbt_id`);
...
--
-- AUTO_INCREMENT de la tabla `tbl_libtema`
--
ALTER TABLE `tbl_libtema`
  MODIFY `lbt_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
